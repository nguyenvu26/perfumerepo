...
export default function ManageJournalPage() {
    ...
    const handleDelete = async (id: string) => {
        if (!confirm('Xoá bài tạp chí này?')) return;
        try {
            await journalService.delete(id);
            loadData();
        } catch (e) {
            console.error(e);
            alert('Lỗi xoá tạp chí');
        }
    };
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-serif text-foreground">Quản lý Tạp chí</h1>
                <Link
