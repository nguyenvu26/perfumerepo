...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Title
        ref={ref}
        className={cn('text-2xl font-serif leading-none tracking-tight text-luxury-black dark:text-white', className)}
        {...props}
    />
));
